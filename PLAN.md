...
- [ ] **Pendiente:** correr la app con usuarios OPERADOR y LECTOR **reales**. Los usuarios ya existen en el backend (Fase 8), pero todavia no se entro con ellos, asi que el 403 del servidor sigue sin verse de punta a punta
